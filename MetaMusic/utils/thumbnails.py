...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("MetaMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("MetaMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("MetaMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("MetaMusic/assets/play_icons.png")
